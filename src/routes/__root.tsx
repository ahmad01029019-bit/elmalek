...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "منصة المُلك التعليمية" },
      {
        name: "description",
        content: "منصة تعليمية للمرحلتين الإعدادية والثانوية بجميع الشعب والأنظمة.",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Cairo:wght@400;500;600;700&family=Tajawal:wght@500;700;800&family=Outfit:wght@500;600;700;800&display=swap",
      },
